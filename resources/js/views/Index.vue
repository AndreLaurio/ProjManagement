            ...
            <div class="text-center">
                ...
                <span class="grey--text text--darken-1">Or</span>
                    ...
                    <v-card class="register-card font-body">
                        ...
                        <span class="text-center text-uppercase register-title">Register Form</span>
                        </v-card-title>
                        <v-card-text>
                            <div class="ml-8 mr-8">
                                <v-row>
                                    <v-col>
                                        <label for="first-name" class="text-md-body-1 register-input"> First Name</label>
                                        <v-text-field outlined clearable id="first-name" v-model="register_data.first_name"></v-text-field>
                                    </v-col>
                                    <v-col>
                                        <label for="last-name" class="text-md-body-1 register-input"> Last Name</label>
                                        <v-text-field outlined clearable id="last-name" v-model="register_data.last_name"></v-text-field>
                                    </v-col>
                                </v-row>
                            </div>
                            <!-- <div class="ml-8 mr-8">
                            ...
                            <div class="ml-8 mr-8">
                                <label for="register-email" class="text-md-body-1"> Email Address</label>
                                <v-text-field outlined prepend-inner-icon="mdi-email-outline" clearable id="register-email" v-model="register_data.email"></v-text-field>
                            </div>
                            <div class="ml-8 mr-8">
                                ...
                                <v-row>
                                    <v-col>
                                        <label for="register-password" class="text-md-body-1 register-input"> Password</label>
                                        <v-text-field outlined clearable prepend-inner-icon="mdi-key-variant" id="register-password" v-model="register_data.password"></v-text-field>
                                    </v-col>
                                    <v-col>
                                        <label for="register-confirm-password" class="text-md-body-1 register-input"> Confirm Password</label>
                                        <v-text-field outlined clearable prepend-inner-icon="mdi-key-variant" id="register-confirm-password" v-model="register_data.confirm_password"></v-text-field>
                                    </v-col>
                                </v-row>
                            </div>
            ...
            <v-card class="mt-5 mx-auto" width="500">
                <v-card-text>
                    <div class="ml-8 mr-8 pt-10">
                        ...
                        <v-text-field solo prepend-inner-icon="mdi-email-outline" clearable id="email" class="input-login"></v-text-field>
                        ...
                        <div class="text-right mr-5">
                            ...
                            >
                    <template v-slot:activator="{ on, attrs }">
                        <span class="indigo--text" v-bind="attrs" v-on="on">Forgot your password?</span>
                    </template>
                    <v-card class="register-card font-body">
                        <v-card-title class="pl-8 pr-8 pt-8 justify-center">
                        <span class="text-center text-uppercase register-title">Reset Password</span>
                        </v-card-title>
                        <v-card-text>
                            <div class="ml-8 mr-8">
                                <label for="register-email" class="text-md-body-1"> Email Address</label>
                                <v-text-field outlined prepend-inner-icon="mdi-email-outline" clearable id="register-email" v-model="forgotPw_data.email"></v-text-field>
                            </div>
                        </v-card-text>
                        <v-card-actions>
                        <v-spacer></v-spacer>
                    ...
                    <div class="text-center mt-5">
                        <v-btn depressed color="primary" class="signin pr-12 pl-12" v-on:click="login">Sign in</v-btn>
